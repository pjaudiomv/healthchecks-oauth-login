...
def login(request):
    ...
    ctx = {
        'social_auth_enabled': len(settings.AUTH_PROVIDERS) != 0,
        'custom_oauth_link_css': settings.CUSTOM_OAUTH2_LINK_CSS,
        'disable_local_login': settings.OAUTH_DISABLE_LOCAL_LOGIN,
        'disable_magic_link_login': settings.OAUTH_DISABLE_MAGIC_LOGIN,
        "page": "login",
        "form": form,
